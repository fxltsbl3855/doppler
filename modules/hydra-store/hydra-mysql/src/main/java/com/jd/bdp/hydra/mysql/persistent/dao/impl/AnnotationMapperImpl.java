...
public class AnnotationMapperImpl implements AnnotationMapper {
    ...
    @Override
    public void addAnnotationBatch(List<Absannotation> absannotationList) {
        sqlSession.insert("addAnnotationBatch", absannotationList);
    }

    @Override
    public void addAnnotationWeb(AnnotationWeb annotationWeb){
        sqlSession.insert("addAnnotationWeb", annotationWeb);
    }

    @Override
    public void addAnnotationWebBatch(List<AnnotationWeb> annotationWebList) {
        sqlSession.insert("addAnnotationWebBatch", annotationWebList);
    }

    @Override
    public void addBuslogBatch(List<BusLog> busLogList) {
        sqlSession.insert("addBusLogBatch", busLogList);
    }

    @Override
    public void addBuslog(BusLog busLog){
        sqlSession.insert("addBusLog", busLog);
    }
